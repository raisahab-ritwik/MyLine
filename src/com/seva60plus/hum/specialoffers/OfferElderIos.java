...
public class OfferElderIos extends Fragment {
	 @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	            Bundle savedInstanceState) {
	 
	        View ios = inflater.inflate(R.layout.offer_elder_ios_frag, container, false);
	        ((TextView)ios.findViewById(R.id.textView)).setText("RootsConnect");
			...
			call_img.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					try {
					    ...
					    my_callIntent.setData(Uri.parse("tel:"+"+919818623313"));
				...
				public void onClick(View v) {
					...
					try {
						Intent i = new Intent(Intent.ACTION_VIEW, 
								Uri.parse("http://www.rootsconnect.in"));
						startActivity(i);
					} catch (ActivityNotFoundException e) {
					    Toast.makeText(getActivity(), "Error in your phone call"+e.getMessage(), Toast.LENGTH_LONG).show();
					}
