...
public class OffersListMedicalActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		banner.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				// Take action.
				/*
				 * Intent myIntent = new Intent(OffersListMedicalActivity.this,
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (Util.isInternetAvailable(OffersListMedicalActivity.this)) {

					Intent i = new Intent(OffersListMedicalActivity.this, HumDetailsView.class);
					startActivity(i);
					overridePendingTransition(R.anim.slide_in_right, R.anim.slide_leave_right);

				} else {

					Intent i = new Intent(OffersListMedicalActivity.this, NoInternetPage.class);
					startActivity(i);
					overridePendingTransition(0, 0);
	...
	public void onHomeClick(View v) {
		startActivity(new Intent(OffersListMedicalActivity.this, DashboardActivity.class));
		finish();
	}
}