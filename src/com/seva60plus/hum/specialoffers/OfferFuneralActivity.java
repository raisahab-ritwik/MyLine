...
public class OfferFuneralActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (Util.isInternetAvailable(OfferFuneralActivity.this)) {
					Intent i = new Intent(OfferFuneralActivity.this, HumDetailsView.class);
					startActivity(i);
					overridePendingTransition(R.anim.slide_in_right, R.anim.slide_leave_right);
				} else {
					Intent i = new Intent(OfferFuneralActivity.this, NoInternetPage.class);
					startActivity(i);
					overridePendingTransition(0, 0);
				}
	...
	public void onHomeClick(View v) {
		startActivity(new Intent(OfferFuneralActivity.this, DashboardActivity.class));
		finish();
	}
}
