...
public class OffersListFinancialActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		banner.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				/*
				 * Intent myIntent = new
				 * Intent(OffersListFinancialActivity.this, AdBanner.class);
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (Util.isInternetAvailable(OffersListFinancialActivity.this)) {
					Intent i = new Intent(OffersListFinancialActivity.this, HumDetailsView.class);
					startActivity(i);
					overridePendingTransition(R.anim.slide_in_right, R.anim.slide_leave_right);
				} else {
					Intent i = new Intent(OffersListFinancialActivity.this, NoInternetPage.class);
					startActivity(i);
					overridePendingTransition(0, 0);
				}
			}
	...
	public void onHomeClick(View v) {
		startActivity(new Intent(OffersListFinancialActivity.this, DashboardActivity.class));
		finish();
	}
}