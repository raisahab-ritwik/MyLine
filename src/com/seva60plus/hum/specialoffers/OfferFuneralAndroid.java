...
public class OfferFuneralAndroid extends Fragment {
	...
	@Override
		...
		android = inflater.inflate(R.layout.offer_funeral_android_frag, container, false);
	        ((TextView)android.findViewById(R.id.textView)).setText("Sukhant Funeral Management Pvt Ltd");
