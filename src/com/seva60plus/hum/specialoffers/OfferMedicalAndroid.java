...
public class OfferMedicalAndroid extends Fragment {
	...
	@Override
		...
		android = inflater.inflate(R.layout.offer_medical_android_frag, container, false);
	        ((TextView)android.findViewById(R.id.textView)).setText("Old is Gold Store");
			...
			call_img.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					try {
					    ...
					    my_callIntent.setData(Uri.parse("tel:"+"+914424466244"));
			...
			call_txt.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					try {
					    Intent my_callIntent = new Intent(Intent.ACTION_CALL);
					    my_callIntent.setData(Uri.parse("tel:"+"+91228655808080"));
					    //here the word 'tel' is important for making a call...
					    startActivity(my_callIntent);
					} catch (ActivityNotFoundException e) {
					    Toast.makeText(getActivity(), "Error in your phone call"+e.getMessage(), Toast.LENGTH_LONG).show();
				...
				public void onClick(View v) {
					...
					try {
						Intent i = new Intent(Intent.ACTION_VIEW, 
								Uri.parse("http://www.sukhantfuneral.com"));
						startActivity(i);
					} catch (ActivityNotFoundException e) {
					    Toast.makeText(getActivity(), "Error in your phone call"+e.getMessage(), Toast.LENGTH_LONG).show();
					}
