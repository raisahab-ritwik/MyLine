...
public class MediaCentreFood extends BaseActivity implements OnClickListener, YoutubePlayListListener {
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlayListAsync mAsyncTask = new YoutubePlayListAsync(mContext, "PLxkAcus7ChPHydNBuw9U8QodKzhrLuygR");
