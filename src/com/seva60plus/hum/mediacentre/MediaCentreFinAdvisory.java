...
public class MediaCentreFinAdvisory extends BaseActivity implements OnClickListener, YoutubePlayListListener {
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlayListAsync mAsyncTask = new YoutubePlayListAsync(mContext, "PLxkAcus7ChPF3MVwq7AAnvh2zw-WhGZ3o");
