...
public class MediaCentreArtNCulture extends BaseActivity implements OnClickListener, YoutubePlayListListener {
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlayListAsync mAsyncTask = new YoutubePlayListAsync(mContext, "PLxkAcus7ChPGAsPSXyr9sCJm9Cg41Zbzn");
