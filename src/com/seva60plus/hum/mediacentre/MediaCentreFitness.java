...
public class MediaCentreFitness extends BaseActivity implements OnClickListener, YoutubePlayListListener {
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlayListAsync mAsyncTask = new YoutubePlayListAsync(mContext, "PLxkAcus7ChPE9Da1LULRAJlmYI0iGPISw");
