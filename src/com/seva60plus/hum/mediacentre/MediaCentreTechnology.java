...
public class MediaCentreTechnology extends BaseActivity implements OnClickListener, YoutubePlayListListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = MediaCentreTechnology.this;
		initView();
	...
	private void initView() {
		...
		tv_fin_advisory.setText("TECHNOLOGY");
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlayListAsync mAsyncTask = new YoutubePlayListAsync(mContext, "PLxkAcus7ChPGg4okgMcfOwKkArlGgeIYN");
